...
```
fiorucci/nginx-instance-counter:2.3
```
...
docker build --no-cache -t PRIVATE_REGISTRY:PORT/nginx-instance-counter:2.3 .
docker push PRIVATE_REGISTRY:PORT/nginx-instance-counter:2.3
```
